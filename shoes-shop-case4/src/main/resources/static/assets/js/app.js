...
//
//     static BASE_URL_CLOUD_IMAGE = "https://res.cloudinary.com/dly7s5c1q/image/upload";
//     static BASE_URL_CLOUD_VIDEO = "https://res.cloudinary.com/dly7s5c1q/video/upload";
...
//
// class Product {
//     constructor(id, name, description,color, size, category, fileId, fileName, fileFolder, fileType) {
//         this.id = id;
//         this.name = name;
